class VshPhp72 < Formula
  ...
  bottle do
    ...
    sha256 "14d4cdb69536309ee2a8f97e15f248fdd74f74d1fb12f7e130c51ba42d6efad5" => :catalina
    sha256 "b887c85e2027de323c2dbebd3f0cc6ada83dfdcd7b1287974ccf9c193db6918f" => :mojave
  end
